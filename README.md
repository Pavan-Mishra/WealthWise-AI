...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00C9A7,100:4D96FF&height=220&section=header&text=WealthWise%20AI&fontSize=50&fontColor=ffffff&animation=fadeIn"/>

# WealthWise AI – Financial Freedom for Irregular Income

<img src="https://readme-typing-svg.herokuapp.com?color=00C9A7&size=24&center=true&vCenter=true&width=800&lines=AI-Powered+Personal+Finance+Platform;Built+for+Freelancers+and+Gig+Workers;Smart+Budgeting+for+Variable+Income;Predict.+Save.+Invest.+Grow."/>
...
```mermaid
graph TD
A[Android App] --> B[Spring Boot Backend]
B --> C[MongoDB Database]
B --> D[FastAPI ML Service]
D --> E[OpenAI API]
E --> F[AI Financial Advisor]
```
...
```mermaid
graph TD
A[SMS Transactions] --> B[Expense Extraction]
B --> C[Expense Categorization]
C --> D[MongoDB Storage]
D --> E[Analytics Dashboard]
E --> F[AI Financial Coach]
F --> G[Financial Recommendations]
```
...
<p align="center">
<img width="859" height="375" alt="screenchot" src="https://github.com/user-attachments/assets/2c457aa4-0dde-4c8a-ad6d-bdb4291cf6ff" />
</p>
